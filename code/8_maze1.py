...
MAZE_H = 21  # 格子的高
MAZE_W = 21  # 格子的宽
writer=SummaryWriter('8_maze1')
#起始点、目标点以及SVO
goal1=np.array([9 * UNIT, 11 * UNIT])
goal2=np.array([2 * UNIT, 10 * UNIT])
goal3=np.array([8 * UNIT, 10 * UNIT])
goal4=np.array([3 * UNIT, 11 * UNIT])
goal5=np.array([3 * UNIT, 14 * UNIT])
goal6=np.array([2 * UNIT, 15 * UNIT])
goal7=np.array([9 * UNIT, 14 * UNIT])
goal8=np.array([8 * UNIT, 15 * UNIT])
origin1 = np.array([70, 50])
origin2 = np.array([210, 50])
origin3 = np.array([350, 50])
origin4 = np.array([10,50])
origin5 = np.array([110,70])
origin6 = np.array([150,70])
origin7 = np.array([250,70])
origin8 = np.array([310,70])
    ...
    def _build_maze(self):
        ...
        for k in range(1, 17, 5):
            for i in range(4, 18, 4):
                ...
                round_rectangle(k * UNIT, i * UNIT, (k + 2) * UNIT, (i + 2) * UNIT, fill='seagreen',radius=70,width=1)

        # 目的地
        self.target1 = self.canvas.create_rectangle(
            9 * UNIT, 11 * UNIT, 10 * UNIT, 12 * UNIT,
            fill='SkyBlue1')
...
def  nash_learn(state):#通过casadi找最优控制
    ...
    for inter3 in range(1,4):
        g.append(ca.norm_2((x[0:2,inter3] + interval) - (x[2:4,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[0:2, inter3] + interval) - (x[4:6,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[0:2, inter3] + interval) - (x[6:8,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[0:2, inter3] + interval) - (x[8:10,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[0:2, inter3] + interval) - (x[10:12,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[0:2, inter3] + interval) - (x[12:14,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[0:2, inter3] + interval) - (x[14:16,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)

        g.append(ca.norm_2((x[2:4, inter3] + interval) - (x[4:6,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[2:4, inter3] + interval) - (x[6:8,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[2:4, inter3] + interval) - (x[8:10,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[2:4, inter3] + interval) - (x[10:12,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[2:4, inter3] + interval) - (x[12:14,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[2:4, inter3] + interval) - (x[14:16,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)

        g.append(ca.norm_2((x[4:6, inter3] + interval) - (x[6:8,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[4:6, inter3] + interval) - (x[8:10,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[4:6, inter3] + interval) - (x[10:12,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[4:6, inter3] + interval) - (x[12:14,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[4:6, inter3] + interval) - (x[14:16,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)

        g.append(ca.norm_2((x[6:8, inter3] + interval) - (x[8:10,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[6:8, inter3] + interval) - (x[10:12,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[6:8, inter3] + interval) - (x[12:14,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[6:8, inter3] + interval) - (x[14:16,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)

        g.append(ca.norm_2((x[8:10, inter3] + interval) - (x[10:12,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[8:10, inter3] + interval) - (x[12:14,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[8:10, inter3] + interval) - (x[14:16,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)

        g.append(ca.norm_2((x[10:12, inter3] + interval) - (x[12:14,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        g.append(ca.norm_2((x[10:12, inter3] + interval) - (x[14:16,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)

        g.append(ca.norm_2((x[12:14, inter3] + interval) - (x[14:16,inter3] + interval))-24)
        lbg.append(0)
        ubg.append(np.inf)
        #
        # #与障碍物的距离
